...
CONFIG_PATH="../configs/robustness_evaluation.yaml"
LOG_DIR="../logs"
MODEL_DIR="../models"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <model_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/robustness_evaluation.yaml)"
...
python ../src/robustness/robustness_evaluation.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --model-dir "$MODEL_DIR"
