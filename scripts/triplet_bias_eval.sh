...
CONFIG_PATH="../configs/triplet_bias_eval.yaml"
LOG_DIR="../logs"
MODEL_DIR="../models"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <model_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/triplet_bias_eval.yaml)"
...
python ../src/texture_shape_bias/triplet_bias_eval.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --model-dir "$MODEL_DIR"