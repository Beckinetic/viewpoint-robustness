...
CONFIG_PATH="../configs/plot_robustness.yaml"
LOG_DIR="../logs"
PLOT_DIR="../plots"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <plot_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/plot_robustness.yaml)"
...
python ../src/plot/plot_robustness.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --plot-dir "$PLOT_DIR"