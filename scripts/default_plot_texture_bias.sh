...
CONFIG_PATH="../configs/default_plot_texture_bias.yaml"
LOG_DIR="../logs"
PLOT_DIR="../plots"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <plot_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/default_plot_loss_acc.yaml)"
...
python ../src/plot/plot_texture_bias.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --plot-dir "$PLOT_DIR"