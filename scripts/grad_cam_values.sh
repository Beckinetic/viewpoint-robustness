...
CONFIG_PATH="../configs/grad_cam_values.yaml"
LOG_DIR="../logs"
MODEL_DIR="../models"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <model_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/grad_cam_values.yaml)"
...
python ../src/activation/grad_cam_values.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --model-dir "$MODEL_DIR"