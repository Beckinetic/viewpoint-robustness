...
CONFIG_PATH="../configs/plot_grad_cam.yaml"
LOG_DIR="../logs"
PLOT_DIR="../plots"

usage() {
    echo "Usage: $0 [-c <config_path>] [-l <log_dir>] [-m <plot_dir>]"
    echo "  -c, --config       Path to the configuration file (default: configs/plot_grad_cam.yaml)"
...
python ../src/plot/plot_grad_cam.py "$CONFIG_PATH" --log-dir "$LOG_DIR" --plot-dir "$PLOT_DIR"